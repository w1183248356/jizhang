...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        JiZhangDtlDao.createTable(db, ifNotExists);
        TotalMoneyDao.createTable(db, ifNotExists);
        ExpendReasonDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        JiZhangDtlDao.dropTable(db, ifExists);
        TotalMoneyDao.dropTable(db, ifExists);
        ExpendReasonDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(JiZhangDtlDao.class);
        registerDaoClass(TotalMoneyDao.class);
        registerDaoClass(ExpendReasonDao.class);
